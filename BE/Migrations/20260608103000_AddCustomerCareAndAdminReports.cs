...
{
    [Migration("20260608103000_AddCustomerCareAndAdminReports")]
    public partial class AddCustomerCareAndAdminReports : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedResolution = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(name: "IX_SupportRequests_OrderId", table: "SupportRequests", column: "OrderId");
            migrationBuilder.CreateIndex(name: "IX_SupportRequests_CustomerId", table: "SupportRequests", column: "CustomerId");
        }
